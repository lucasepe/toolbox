...
import (
	...
	"github.com/lucasepe/toolbox/flags"
)

func ExampleEnum() {
	mode := flags.Enum{Choices: []string{"fast", "exact"}}
	fruit := flags.Enums{Choices: []string{"apple", "pear"}}
	letters := flags.EnumsCSV{
		Choices:       []string{"a", "A", "b", "B"},
		CaseSensitive: true,
	}
	levels := flags.EnumSetCSV{
...
func TestEnum(t *testing.T) {
	fv := flags.Enum{Choices: []string{"first", "second"}}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnumCaseSensitive(t *testing.T) {
	fv := flags.Enum{Choices: []string{"first", "FIRST"}, CaseSensitive: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnums(t *testing.T) {
	fv := flags.Enums{Choices: []string{"first", "second"}}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnumsCaseSensitive(t *testing.T) {
	fv := flags.Enums{Choices: []string{"first", "FIRST", "fIrSt"}, CaseSensitive: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnumSet(t *testing.T) {
	fv := flags.EnumSet{Choices: []string{"first", "second"}}
	var fs flag.FlagSet
	fs.Var(&fv, "enum-set", "")
...
func TestEnumSetCaseSensitive(t *testing.T) {
	fv := flags.EnumSet{Choices: []string{"first", "FIRST", "fIrSt"}, CaseSensitive: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnumsCSV(t *testing.T) {
	fv := flags.EnumsCSV{Choices: []string{"first", "second"}}
	var fs flag.FlagSet
	fs.Var(&fv, "enums-csv", "")
...
func TestEnumsCSVCaseSensitive(t *testing.T) {
	fv := flags.EnumsCSV{Choices: []string{"first", "FIRST", "fIrSt"}, CaseSensitive: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnumsCSVSeparator(t *testing.T) {
	fv := flags.EnumsCSV{Choices: []string{"first", "second"}, Separator: ";"}
	var fs flag.FlagSet
	fs.Var(&fv, "enums-csv", "")
...
func TestEnumsCSVAccumulate(t *testing.T) {
	fv := flags.EnumsCSV{Choices: []string{"first", "second"}, Accumulate: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enums-csv", "")
...
func TestEnumSetCSV(t *testing.T) {
	fv := flags.EnumSetCSV{Choices: []string{"first", "second"}, Accumulate: true}
	var fs flag.FlagSet
...
func TestEnumSetCSVCaseSensitive(t *testing.T) {
	fv := flags.EnumSetCSV{Choices: []string{"first", "FIRST", "fIrSt"}, CaseSensitive: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enum", "")
...
func TestEnumSetCSVSeparator(t *testing.T) {
	fv := flags.EnumSetCSV{Choices: []string{"first", "second"}, Separator: ";", Accumulate: true}
	var fs flag.FlagSet
	fs.Var(&fv, "enum-set-csv", "")
...
func TestEnumSetCSVFail(t *testing.T) {
	...
	fv := flags.EnumSetCSV{Choices: []string{"first", "second"}}
	var fs flag.FlagSet
	fs.Var(&fv, "enum-set-csv", "")
